const en = {
  ...
  partA: "PART A · TIME, SPEED & COMPREHENSION", partB: "PART B · MISCUE & WORD ACCURACY", partC: "PART C · READING PROFILE",
  timeReadingLbl: "TIME SPENT READING", combinedTimeLbl: "TOTAL TIME (READING + QUESTIONS)",
  compScoreLbl: "COMPREHENSION SCORE", totalMiscuesLbl: "Total miscues", wordsInPassage: "Words in the passage",
  wordReadingLbl: "Word Reading", compShortLbl: "Comprehension", profileMatrixNote: "Word Reading level × Comprehension level — Frustration in either always means a Frustration profile.",
...
const fil = {
  ...
  partA: "PART A · ORAS, BILIS & PAG-UNAWA", partB: "PART B · MGA MALI & KAWASTUHAN NG SALITA", partC: "PART C · PROFILE SA PAGBASA",
  timeReadingLbl: "ORAS NG PAGBASA", combinedTimeLbl: "KABUUANG ORAS (PAGBASA + MGA TANONG)",
  compScoreLbl: "ISKOR SA PAG-UNAWA", totalMiscuesLbl: "Kabuuang mali", wordsInPassage: "Mga salita sa binasa",
  wordReadingLbl: "Pagbasa ng Salita", compShortLbl: "Pag-unawa", profileMatrixNote: "Antas ng Pagbasa ng Salita × Antas ng Pag-unawa — kapag Frustration ang alinman, Frustration ang profile.",
